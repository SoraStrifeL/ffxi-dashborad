...
exports.CURATED_KEYS = exports.SCAN_FILES = exports.RATE_CATALOG = exports.SETTINGS_DIR = void 0;
exports.readRate = readRate;
exports.writeRate = writeRate;
exports.scanSettingsFile = scanSettingsFile;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
exports.SETTINGS_DIR = '/ffxi-settings';
exports.RATE_CATALOG = [
    // Experience
...
exports.SCAN_FILES = ['main.lua', 'map.lua', 'login.lua'];
exports.CURATED_KEYS = new Set(exports.RATE_CATALOG.map(e => e.key));
function scanSettingsFile(file) {
    const entries = [];
    const tryPaths = [path_1.default.join(exports.SETTINGS_DIR, file), path_1.default.join(exports.SETTINGS_DIR, 'default', file)];
    let content = '';
    ...
    while ((m = re.exec(content)) !== null) {
        ...
        entries.push({ key, value, curated: exports.CURATED_KEYS.has(key) });
    }
